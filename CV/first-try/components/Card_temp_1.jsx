...
export default function Card_temp_1({ toggle, settoggle }) {
  return (
    <div className="m-4 w-[30rem] h-[37rem]  rounded-2xl bg-white dark:bg-slate-800 shadow-lg dark:shadow-slate-700 flex-row-reverse ease-linear duration-300 ">
      <div className=" h-1/3 w-full rounded-2xl basis-2/3 relative">
      ...
      <div className=" pt-8 w-full mr-2 rounded-2xl  sm:pt-1">
        <h1 className="m-6 text-4xl font-bold dark:text-white ">Front-End, Web, App</h1>

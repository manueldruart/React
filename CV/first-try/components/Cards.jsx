...
export default function Cards() {
    return (
        <div className="max-w-sm w-1/2 lg:max-w-full lg:flex pt-12 pr-24" >
            <div className="h-48 w-1/2 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l-2xl text-center overflow-hidden bg-[url('/coding.png')]" />
            <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r-2xl p-4 flex flex-col justify-between leading-normal">
                <div className=" pt-8 w-full mr-2 rounded-2xl  sm:pt-1">
                    <h1 className="m-6 text-4xl font-bold dark:text-white ">Front-End, Web, App
                    </h1>
                <div className=" pt-8 pr-2 pl-2 flex text-lg flex-row justify-around flex-wrap">
                    ...
                    <a
                        className="md:m-8 m-auto mt-8 bg-[#5865F2] shadow-md shadow-[#5865f28a] pt-2 pb-2 pl-6 pr-4 rounded-xl flex flex-row justify-center items-center hover:bg-[#424bb6] ease-linear duration-300"
